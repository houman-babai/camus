...
public class LogEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static balaena.common.serde.avro.LogEvent.Builder newBuilder() {
    return new balaena.common.serde.avro.LogEvent.Builder();
  }
  
  /** Creates a new LogEvent RecordBuilder by copying an existing Builder */
  public static balaena.common.serde.avro.LogEvent.Builder newBuilder(balaena.common.serde.avro.LogEvent.Builder other) {
    return new balaena.common.serde.avro.LogEvent.Builder(other);
  }
  
  /** Creates a new LogEvent RecordBuilder by copying an existing LogEvent instance */
  public static balaena.common.serde.avro.LogEvent.Builder newBuilder(balaena.common.serde.avro.LogEvent other) {
    return new balaena.common.serde.avro.LogEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LogEvent>
    ...
    private Builder() {
      super(balaena.common.serde.avro.LogEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(balaena.common.serde.avro.LogEvent.Builder other) {
      super(other);
    ...
    private Builder(balaena.common.serde.avro.LogEvent other) {
            super(balaena.common.serde.avro.LogEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'hostName' field */
    public balaena.common.serde.avro.LogEvent.Builder setHostName(java.lang.CharSequence value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearHostName() {
      hostName = null;
    ...
    /** Sets the value of the 'logType' field */
    public balaena.common.serde.avro.LogEvent.Builder setLogType(java.lang.CharSequence value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearLogType() {
      logType = null;
    ...
    /** Sets the value of the 'time' field */
    public balaena.common.serde.avro.LogEvent.Builder setTime(long value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearTime() {
    ...
    /** Sets the value of the 'level' field */
    public balaena.common.serde.avro.LogEvent.Builder setLevel(java.lang.CharSequence value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearLevel() {
      level = null;
    ...
    /** Sets the value of the 'hash' field */
    public balaena.common.serde.avro.LogEvent.Builder setHash(java.lang.CharSequence value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearHash() {
      hash = null;
    ...
    /** Sets the value of the 'body' field */
    public balaena.common.serde.avro.LogEvent.Builder setBody(java.lang.CharSequence value) {
    ...
    public balaena.common.serde.avro.LogEvent.Builder clearBody() {
      body = null;
